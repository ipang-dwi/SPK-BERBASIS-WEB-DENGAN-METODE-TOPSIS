							...
							<form role="form" method="post" action="add.php">
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="alternatif" id="alternatif" placeholder="Jenis Kayu">
                                        </div>
                                        <div class="form-group">
                                            <label for="k1">K1</label>
                                            <input type="text" class="form-control" name="k1" id="k1" placeholder="Nilai K1">
                                        </div>
										<div class="form-group">
                                            <label for="k2">K2</label>
                                            <input type="text" class="form-control" name="k2" id="k2" placeholder="Nilai K2">
                                        </div>
										<div class="form-group">
                                            <label for="k3">K3</label>
                                            <input type="text" class="form-control" name="k3" id="k3" placeholder="Nilai K3">
                                        </div>
										<div class="form-group">
                                            <label for="k4">K4</label>
                                            <input type="text" class="form-control" name="k4" id="k4" placeholder="Nilai K4">
                                        </div>
										<div class="form-group">
                                            <label for="k5">K5</label>
                                            <input type="text" class="form-control" name="k5" id="k5" placeholder="Nilai K5">
                                        </div>
										<div class="form-group">
                                            <label for="k6">K6</label>
                                            <input type="text" class="form-control" name="k6" id="k6" placeholder="Nilai K6">
                                        </div>
                                    </div><!-- /.box-body -->
